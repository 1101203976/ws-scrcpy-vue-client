...
function createTouchMessage(action, pointerId, x, y, screenWidth, screenHeight, pressure = 1.0, buttons = 1) {
  ...
  // pointerId: 8 bytes (long)
  view.setUint32(offset, 0, false) // high 4 bytes
  offset += 4
  view.setUint32(offset, pointerId, false) // low 4 bytes
  offset += 4
  ...
  view.setUint16(offset, pressureValue, false)
  offset += 2
...
function createScrollMessage(x, y, screenWidth, screenHeight, hScroll, vScroll) {
  ...
  // hScroll: 4 bytes (signed)
  view.setInt32(offset, hScroll, false)
  offset += 4
  
  // vScroll: 4 bytes (signed)
